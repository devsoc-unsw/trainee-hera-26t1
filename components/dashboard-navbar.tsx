...
export function DashboardNavbar({ brandName = "Atlas" }: { brandName?: string }) {
  return (
    <header className="absolute left-0 right-0 top-0 z-20 w-full shrink-0 border-b border-atlas-teal/15 bg-white/20 shadow-[0_1px_0_rgba(255,255,255,0.45)_inset] backdrop-blur-md">
